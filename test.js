...
console.log('path from 1 to 9:', graph.pathFromTo(1,9)); // => 6-4-3-2-1
// console.log('path from 1 to 6:', graph.pathFromTo(1,6)); // => 6-4-3-2-1

console.log('path from 8 to 3:', graph.pathFromTo(8,3)); // => 6-4-3-2-1
